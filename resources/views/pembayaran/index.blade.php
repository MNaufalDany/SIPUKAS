        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <a href="/pembayaran/create" class="btn btn-md btn-success mb-3">TAMBAH BAYAR</a>
        ...
        <tr>
            ...
            <td class="text-center">
                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('pembayaran.destroy', $pembayaran->id) }}" method="POST">
                    ...
                    <a href="{{ route('pembayaran.history', $pembayaran->id_siswa) }}" class="btn btn-sm btn-info mx-2">HISTORY</a>
                    {{-- @csrf
                    @method('DELETE')
